<div class="wrapper">
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="btn1" id="btn1"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="btn_link1" id="btn_link1"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="video_link1" id="video_link1"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="title3" id="title3"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="btn2" id="btn2"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="btn_link2" id="btn_link2"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="video_link2" id="video_link2"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="subj1" id="subj1"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="amount1" id="amount1"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="subj2" id="subj2"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="amount2" id="amount2"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="subj3" id="subj3"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="amount3" id="amount3"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="subj4" id="subj4"
        ...
        <div class="format-setting">
            ...
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="amount4" id="amount4"
    ...
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="video_link6" id="video_link6"
