<div class="wrapper">
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="extra_text" id="extra_text" value="<?php echo isset($options['setting']['extra_text']) && !empty($options['setting']['extra_text']) ? $options['setting']['extra_text'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="extra_btn" id="extra_btn" value="<?php echo isset($options['setting']['extra_btn']) && !empty($options['setting']['extra_btn']) ? $options['setting']['extra_btn'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="setting-wrapper bottom-line">
        ...
        <div class="format-setting">
            <div class="format-setting-inner">
                <div class="row">
                    <input class="input-setting" type="text" name="extra_link" id="extra_link" value="<?php echo isset($options['setting']['extra_link']) && !empty($options['setting']['extra_link']) ? $options['setting']['extra_link'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
